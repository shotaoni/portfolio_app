...
resource "aws_codepipeline" "codepipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ClusterName = aws_ecs_cluster.tante-ecs-cluster.name
        ServiceName = aws_ecs_service.tante-api-ecs-service.name
    ...
    action {
      ...
      configuration = {
        ClusterName = aws_ecs_cluster.tante-ecs-cluster.name
        ServiceName = aws_ecs_service.tante-front-ecs-service.name
